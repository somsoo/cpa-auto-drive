...
def generate_post(campaign, keyword):
    ...
    profile_prompt = f"당신은 30~50대를 위한 전문 '신차 구매 및 장기렌트/리스 실전 금융 컨설턴트'입니다. 주요 전문 분야: '초기비용 0원 혜택, 사업자 비용처리 및 세금 절감, 딜러별 견적 거품 제거와 비공식 서비스 비교 팁'. '{keyword}'의 타겟 유저가 가장 갈망하는 혜택과 현실적 고민이 무엇인지 전문가의 시각에서 3문장으로 날카롭게 분석하세요."
